...
export function getSatOperator(name) {
    ...
    if (name.includes('POLYITAN')) return 'Russia';
    if (name.includes('QB50'))     return 'Europe';
    if (name.includes('GOMX'))     return 'Denmark';
    if (name.includes('TRITON'))   return 'Denmark';
    if (name.includes('STRAND'))   return 'UK';
    if (name.includes('UWE'))      return 'Germany';
    if (name.includes('BEESAT'))   return 'Germany';
    ...
    if (name.includes('SITRO'))    return 'Unknown';
    if (name.includes('LASARSAT')) return 'Unknown';
    return 'Unknown';
}