...
export function getSatColour(name) {
    ...
    if (name.includes('ELECTRO'))    return 'red';
    ...
    if (name.includes('POLYITAN'))   return 'cyan';
...
export function getSatOperator(name) {
    ...
    if (name.includes('KOMPSAT'))return 'South Korea';
    ...
    if (name.includes('GRBBETA'))    return 'USA';
    if (name.includes('SINOD'))      return 'USA';
    if (name.includes('SAUDI'))      return 'Saudi Arabia';
    if (name.includes('EXACTVIEW'))  return 'Canada';
    if (name.includes('RASAT'))      return 'Türkiye';
    if (name.includes('GOKTURK'))    return 'Türkiye';
    if (name.includes('ITUPSAT'))    return 'Türkiye';
    ...
    if (name.includes('CO3D'))       return 'EU';
